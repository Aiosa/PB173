...
TEST_CASE("SHA-512") {
    ...
    CHECK(hash_sha512(empty) == toUpper(
    ...
    CHECK(hash_sha512(alphabet) == toUpper(
    ...
    std::stringstream alphabet2{"abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"};
    CHECK(hash_sha512(alphabet2) == toUpper(
    ...
    CHECK(hash_sha512(billion_a) == toUpper(
